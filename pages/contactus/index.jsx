...
const contactus = () => {
    return (
        <div className="grid md:grid-cols-2 max-md:w-[98%] items-center lg:grid-cols-3 max-w-6xl mx-auto py-6 
    bg-white font-[sans-serif]">
            <div>
                <h2 className="text-[#333] text-xl font-semibold">Contact Information</h2>
                <div className="px-4 space-y-10 mt-8">
                    <div className="flex">
                        ...
                        <div className="ml-4">
                            <h4 className="text-[#333] text-base font-semibold">Chat to us</h4>
            ...
            <div className="bg-gray-800 rounded-3xl lg:col-span-2 p-10 max-sm:px-6 flex flex-col justify-center max-md:mt-12">
                <h2 className="text-2xl text-orange-500 font-bold">Product or Service Inquiry</h2>
                <p className="text-sm text-gray-400 mt-4">Have some big idea or brand to develop and need help? Then reach out we'd love to hear about your project and provide help.</p>
                <form>
                    <div className="space-y-4 mt-8">
                        <input type="text" placeholder="Full Name" className="px-2 py-3 bg-transparent text-white w-full text-sm border-b border-gray-400 focus:border-white outline-none" />
                        <input type="text" placeholder="Street" className="px-2 py-3 bg-transparent text-white w-full text-sm border-b border-gray-400 focus:border-white outline-none" />
                        <input type="number" placeholder="Phone No." className="px-2 py-3 bg-transparent text-white w-full text-sm border-b border-gray-400 focus:border-white outline-none" />
                        <input type="email" placeholder="Email" className="px-2 py-3 bg-transparent text-white w-full text-sm border-b border-gray-400 focus:border-white outline-none" />
                        <textarea placeholder="Write Message" className="px-2 pt-3 bg-transparent text-white w-full text-sm border-b border-gray-400 focus:border-white outline-none" defaultValue={""} />
                    </div>
                    <button type="button" className="mt-8 flex items-center justify-center text-sm w-full rounded px-4 py-2.5 font-semibold bg-orange-600 text-white hover:bg-orange-700">
