...
const index = () => {
  ...
  <div className="p-4 mx-auto lg:max-w-7xl sm:max-w-full">
    <h2 className="text-4xl font-extrabold text-gray-800 mb-12 text-center">Premium Sneakers</h2>
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
      <div className="bg-gray-50 shadow-md overflow-hidden rounded cursor-pointer hover:-translate-y-2 transition-all relative">
        ...
        <div className="p-6 bg-white">
          ...
          <h4 className="text-lg text-gray-700 font-bold mt-2">$10.5</h4>
          <p className="text-gray-500 text-sm mt-2">5 types of shoos available</p>
      ...
      <div className="bg-gray-50 shadow-md overflow-hidden rounded cursor-pointer hover:-translate-y-2 transition-all relative">
        ...
        <div className="p-6 bg-white">
          ...
          <h4 className="text-lg text-gray-700 font-bold mt-2">$12.5</h4>
          <p className="text-gray-500 text-sm mt-2">5 types of shoos available</p>
          <div className="flex space-x-2 mt-6">
            <svg className="w-5 fill-[#facc15]" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M7 0L9.4687 3.60213L13.6574 4.83688L10.9944 8.29787L11.1145 12.6631L7 11.2L2.8855 12.6631L3.00556 8.29787L0.342604 4.83688L4.5313 3.60213L7 0Z" />
      ...
      <div className="bg-gray-50 shadow-md overflow-hidden rounded cursor-pointer hover:-translate-y-2 transition-all relative">
        ...
        <div className="p-6 bg-white">
          ...
          <h4 className="text-lg text-gray-700 font-bold mt-2">$14.5</h4>
          <p className="text-gray-500 text-sm mt-2">5 types of shoos available</p>
          <div className="flex space-x-2 mt-6">
            <svg className="w-5 fill-[#facc15]" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M7 0L9.4687 3.60213L13.6574 4.83688L10.9944 8.29787L11.1145 12.6631L7 11.2L2.8855 12.6631L3.00556 8.29787L0.342604 4.83688L4.5313 3.60213L7 0Z" />
      ...
      <div className="bg-gray-50 shadow-md overflow-hidden rounded cursor-pointer hover:-translate-y-2 transition-all relative">
        ...
        <div className="p-6 bg-white">
          ...
          <h4 className="text-lg text-gray-700 font-bold mt-2">$15.5</h4>
          <p className="text-gray-500 text-sm mt-2">5 types of shoos available</p>
          <div className="flex space-x-2 mt-6">
            <svg className="w-5 fill-[#facc15]" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M7 0L9.4687 3.60213L13.6574 4.83688L10.9944 8.29787L11.1145 12.6631L7 11.2L2.8855 12.6631L3.00556 8.29787L0.342604 4.83688L4.5313 3.60213L7 0Z" />
