...
const Footer = () => {
    return (
        <footer className="bg-gray-800 py-8 px-8 font-[sans-serif] mt-16">
            <div className="relative">
                <div className="bg-[#633200] gap-2 rounded-md flex items-center sm:px-12 max-sm:px-4 py-4 absolute top-[-66px] w-full">
                    <h6 className="text-white sm:text-xl max-sm:text-sm font-bold">Become a Supplier Today</h6>
                    <button type="button" className="sm:px-4 max-sm:px-2 py-2 sm:text-sm max-sm:text-xs rounded-full text-[#633200] gap-2 bg-white ml-auto">Get
                        Started</button>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8 pt-10">
                    <div>
                        ...
                        <p className="text-gray-400 text-base">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean gravida,
                            mi eu pulvinar cursus, sem elit interdum mauris.</p>
                    </div>
                    <div>
                        <h4 className="text-xl font-bold mb-6 text-white">Services</h4>
                        <ul className="space-y-4">
                            <li><Link href="/" className="text-gray-400 hover:text-gray-300 text-base">Web
                                Development</Link></li>
                            <li><Link href="/" className="text-gray-400 hover:text-gray-300 text-base">Mobile App
                                Development</Link></li>
                            <li><Link href="/" className="text-gray-400 hover:text-gray-300 text-base">UI/UX
                                Design</Link></li>
                            <li><Link href="/" className="text-gray-400 hover:text-gray-300 text-base">Digital
                                Marketing</Link></li>
                        </ul>
                    </div>
                    <div>
            ...
            <div className="bg-gray-900 py-4 px-4 -mx-8 text-center mt-10">
                <p className="text-gray-400 text-base">© 2023<Link href="https://iloveuniquestore-frontend.vercel.app/" target="_blank" className="hover:underline mx-1">ILoveUniqueStore</Link>All Rights Reserved.</p>
            </div>
        </footer>
